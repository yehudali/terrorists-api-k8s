...
class MongoDBConnector:
    def __init__(self) -> None:
        self.mongo_host =os.getenv("HOST", "mongo-0.mongo")
        self.mongo_port = int(os.getenv("PORT", 27017))
        self.username = os.getenv("COLLECTION", "admin")
        self.db_name = os.getenv("DB","threat_db")
...
def get_5_most_dangerous_terrorist(df:DataFrame)->dict:
